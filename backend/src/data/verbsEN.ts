...
export const verbsDataEN: Record<string, VerbEntry[]> = {
    ...
    'a1': [
        ...
        { id: 'want',   infinitive: 'want',   translation: 'vouloir',          type: 'Regular',   color: '#059669', rows: [{ sujet: 'I', present: 'want',    passeCompose: 'wanted',    imparfait: '—',             futurSimple: 'will want'    }, { sujet: 'he/she/it', present: 'wants',      passeCompose: 'wanted',    imparfait: '—',             futurSimple: 'will want'    }] },
        { id: 'need',   infinitive: 'need',   translation: 'avoir besoin de',  type: 'Regular',   color: '#059669', rows: [{ sujet: 'I', present: 'need',    passeCompose: 'needed',    imparfait: '—',             futurSimple: 'will need'    }, { sujet: 'he/she/it', present: 'needs',      passeCompose: 'needed',    imparfait: '—',             futurSimple: 'will need'    }] },
        ...
        { id: 'love',   infinitive: 'love',   translation: 'aimer',            type: 'Regular',   color: '#059669', rows: [{ sujet: 'I', present: 'love',    passeCompose: 'loved',     imparfait: '—',             futurSimple: 'will love'    }, { sujet: 'he/she/it', present: 'loves',      passeCompose: 'loved',     imparfait: '—',             futurSimple: 'will love'    }] },
        ...
        { id: 'see',    infinitive: 'see',    translation: 'voir',             type: 'Irregular', color: '#DC2626', rows: [{ sujet: 'I', present: 'see',     passeCompose: 'saw',       imparfait: '—',             futurSimple: 'will see'     }, { sujet: 'he/she/it', present: 'sees',       passeCompose: 'saw',       imparfait: '—',             futurSimple: 'will see'     }] },
    ...
    'a2': [
        ...
        { id: 'know',   infinitive: 'know',   translation: 'savoir / connaître', type: 'Irregular', color: '#DC2626', rows: [{ sujet: 'I', present: 'know',   passeCompose: 'knew',      imparfait: '—',             futurSimple: 'will know'    }, { sujet: 'he/she/it', present: 'knows',      passeCompose: 'knew',      imparfait: '—',             futurSimple: 'will know'    }] },
    ...
    'b1': [
        ...
        { id: 'understand',  infinitive: 'understand',  translation: 'comprendre', type: 'Irregular', color: '#DC2626', rows: [{ sujet: 'I', present: 'understand',  passeCompose: 'understood', imparfait: '—',                futurSimple: 'will understand' }, { sujet: 'he/she/it', present: 'understands', passeCompose: 'understood', imparfait: '—',                futurSimple: 'will understand' }] },
        { id: 'believe',     infinitive: 'believe',     translation: 'croire',     type: 'Regular',   color: '#059669', rows: [{ sujet: 'I', present: 'believe',     passeCompose: 'believed',   imparfait: '—',                futurSimple: 'will believe'   }, { sujet: 'he/she/it', present: 'believes',    passeCompose: 'believed',   imparfait: '—',                futurSimple: 'will believe'   }] },
        ...
        { id: 'hear',        infinitive: 'hear',        translation: 'entendre',   type: 'Irregular', color: '#DC2626', rows: [{ sujet: 'I', present: 'hear',        passeCompose: 'heard',      imparfait: '—',                futurSimple: 'will hear'      }, { sujet: 'he/she/it', present: 'hears',       passeCompose: 'heard',      imparfait: '—',                futurSimple: 'will hear'      }] },
        { id: 'lose',        infinitive: 'lose',        translation: 'perdre',     type: 'Irregular', color: '#DC2626', rows: [{ sujet: 'I', present: 'lose',        passeCompose: 'lost',       imparfait: 'am losing',        futurSimple: 'will lose'      }, { sujet: 'he/she/it', present: 'loses',       passeCompose: 'lost',       imparfait: 'is losing',        futurSimple: 'will lose'      }] },
