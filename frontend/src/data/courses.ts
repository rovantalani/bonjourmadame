...
export const COURSES_EN: Course[] = [
    {
        ...
        steps: [
            ...
            { id: 'a1en-greetings',       title: 'Salutations & Essentiels',     module: 'vocabulary', type: 'vocabulary', contentId: 'greetings-basics',       path: '/vocabulary/greetings-basics',         unit: 1 },
            { id: 'a1en-numbers',         title: 'Les Chiffres (1–100)',          module: 'vocabulary', type: 'vocabulary', contentId: 'numbers-time',            path: '/vocabulary/numbers-time',             unit: 1 },
            { id: 'a1en-days-months',     title: 'Jours & Mois',                  module: 'vocabulary', type: 'vocabulary', contentId: 'days-months',             path: '/vocabulary/days-months',              unit: 1 },
            { id: 'a1en-colors',          title: 'Couleurs & Descriptions',       module: 'vocabulary', type: 'vocabulary', contentId: 'colors-descriptions',     path: '/vocabulary/colors-descriptions',      unit: 1 },
            { id: 'a1en-family',          title: 'Famille & Relations',           module: 'vocabulary', type: 'vocabulary', contentId: 'family-relationships',    path: '/vocabulary/family-relationships',     unit: 1 },
            ...
            { id: 'a1en-plurals',         title: 'Pluriels & Dénombrables',       module: 'lectures', type: 'grammar',    contentId: 'en-plurals-nouns',        path: '/lectures/grammar/en-plurals-nouns',   unit: 2 },
            { id: 'a1en-questions',       title: 'Poser des Questions',           module: 'lectures', type: 'grammar',    contentId: 'en-questions',            path: '/lectures/grammar/en-questions',       unit: 2 },
            { id: 'a1en-negation',        title: 'La Négation',                   module: 'lectures', type: 'grammar',    contentId: 'en-negation',             path: '/lectures/grammar/en-negation',        unit: 2 },
            ...
            { id: 'a1en-home',            title: 'Maison & Logement',             module: 'vocabulary', type: 'vocabulary', contentId: 'home-living',             path: '/vocabulary/home-living',              unit: 3 },
            { id: 'a1en-clothing',        title: 'Vêtements & Accessoires',       module: 'vocabulary', type: 'vocabulary', contentId: 'clothing-accessories',    path: '/vocabulary/clothing-accessories',     unit: 3 },
            { id: 'a1en-transport',       title: 'Transport & Déplacements',      module: 'vocabulary', type: 'vocabulary', contentId: 'transport-basics',        path: '/vocabulary/transport-basics',         unit: 3 },
            { id: 'a1en-city',            title: 'Lieux de la Ville',             module: 'vocabulary', type: 'vocabulary', contentId: 'city-places',             path: '/vocabulary/city-places',              unit: 3 },
            { id: 'a1en-seasons',         title: 'Saisons & Météo',               module: 'vocabulary', type: 'vocabulary', contentId: 'seasons-weather',         path: '/vocabulary/seasons-weather',          unit: 3 },
            { id: 'a1en-phrases-cafe',    title: 'Au café',                       module: 'lectures', type: 'phrases',    contentId: 'at-the-cafe',             path: '/lectures/phrases/at-the-cafe',        unit: 3 },
            { id: 'a1en-phrases-rest',    title: 'Au restaurant',                 module: 'lectures', type: 'phrases',    contentId: 'at-the-restaurant',       path: '/lectures/phrases/at-the-restaurant',  unit: 3 },
            { id: 'a1en-phrases-shop',    title: 'Faire ses courses',             module: 'lectures', type: 'phrases',    contentId: 'shopping-basics',         path: '/lectures/phrases/shopping-basics',    unit: 3 },
            { id: 'a1en-phrases-daily',   title: 'Routine quotidienne',           module: 'lectures', type: 'phrases',    contentId: 'daily-routine',           path: '/lectures/phrases/daily-routine',      unit: 3 },
            { id: 'a1en-phrases-dir',     title: 'Demander son chemin',           module: 'lectures', type: 'phrases',    contentId: 'asking-directions',       path: '/lectures/phrases/asking-directions',  unit: 3 },
            { id: 'a1en-phrases-around',  title: 'Se déplacer',                   module: 'lectures', type: 'phrases',    contentId: 'getting-around',          path: '/lectures/phrases/getting-around',     unit: 3 },
            { id: 'a1en-phrases-class',   title: 'Phrases de classe',             module: 'lectures', type: 'phrases',    contentId: 'classroom-survival',      path: '/lectures/phrases/classroom-survival', unit: 3 },
            { id: 'a1en-reading-school',  title: 'Lecture : First Day at School', module: 'lectures', type: 'reading',    contentId: 'a1en-first-day',          path: '/lectures/reading/a1en-first-day',     unit: 3 },
            { id: 'a1en-reading-city',    title: 'Lecture : My City',             module: 'lectures', type: 'reading',    contentId: 'a1en-my-city',            path: '/lectures/reading/a1en-my-city',       unit: 3 },
            { id: 'a1en-reading-family',  title: 'Lecture : My Family',           module: 'lectures', type: 'reading',    contentId: 'a1en-my-family',          path: '/lectures/reading/a1en-my-family',     unit: 3 },
            { id: 'a1en-reading-day',     title: 'Lecture : My Day',              module: 'lectures', type: 'reading',    contentId: 'a1en-my-day',             path: '/lectures/reading/a1en-my-day',        unit: 3 },
            { id: 'a1en-reading-park',    title: 'Lecture : A Day at the Park',   module: 'lectures', type: 'reading',    contentId: 'a1en-the-park',           path: '/lectures/reading/a1en-the-park',      unit: 3 },
            { id: 'a1en-reading-pet',     title: 'Lecture : My Pet',              module: 'lectures', type: 'reading',    contentId: 'a1en-my-pet',             path: '/lectures/reading/a1en-my-pet',        unit: 3 },
            { id: 'a1en-reading-birthday',title: 'Lecture : My Birthday Party',   module: 'lectures', type: 'reading',    contentId: 'a1en-birthday-party',     path: '/lectures/reading/a1en-birthday-party', unit: 3 },
    ...
    },
    {
        ...
        steps: [
            ...
            { id: 'a2en-work',            title: 'Travail & Professions',        module: 'vocabulary', type: 'vocabulary', contentId: 'work-professions',        path: '/vocabulary/work-professions',         unit: 1 },
            { id: 'a2en-school',          title: 'École & Éducation',            module: 'vocabulary', type: 'vocabulary', contentId: 'school-education',        path: '/vocabulary/school-education',         unit: 1 },
            { id: 'a2en-weather',         title: 'Météo & Nature',               module: 'vocabulary', type: 'vocabulary', contentId: 'weather-nature',          path: '/vocabulary/weather-nature',           unit: 1 },
            { id: 'a2en-sports',          title: 'Sports & Loisirs',             module: 'vocabulary', type: 'vocabulary', contentId: 'sports-hobbies',          path: '/vocabulary/sports-hobbies',           unit: 1 },
            { id: 'a2en-food-culture',    title: 'Culture culinaire',            module: 'vocabulary', type: 'vocabulary', contentId: 'food-culture',            path: '/vocabulary/food-culture',             unit: 1 },
            ...
            { id: 'a2en-future',          title: 'Le Futur en Anglais',          module: 'lectures', type: 'grammar',    contentId: 'en-future',               path: '/lectures/grammar/en-future',          unit: 2 },
            ...
            { id: 'a2en-health',          title: 'Santé & Médecin',              module: 'vocabulary', type: 'vocabulary', contentId: 'health-doctor',           path: '/vocabulary/health-doctor',            unit: 3 },
            { id: 'a2en-transport-travel',title: 'Voyages & Transport',          module: 'vocabulary', type: 'vocabulary', contentId: 'transport-travel',        path: '/vocabulary/transport-travel',         unit: 3 },
            { id: 'a2en-modal-verbs',     title: 'Les Verbes Modaux',            module: 'lectures', type: 'grammar',    contentId: 'en-modal-verbs',          path: '/lectures/grammar/en-modal-verbs',     unit: 3 },
            { id: 'a2en-verb-patterns',   title: 'Gérondif vs Infinitif',        module: 'lectures', type: 'grammar',    contentId: 'en-verb-patterns',        path: '/lectures/grammar/en-verb-patterns',   unit: 3 },
            { id: 'a2en-on-phone',        title: 'Au Téléphone',                 module: 'lectures', type: 'phrases',    contentId: 'on-the-phone',            path: '/lectures/phrases/on-the-phone',       unit: 3 },
            { id: 'a2en-phrases-feel',    title: 'Exprimer ses sentiments',      module: 'lectures', type: 'phrases',    contentId: 'expressing-feelings',     path: '/lectures/phrases/expressing-feelings', unit: 3 },
            { id: 'a2en-phrases-disagree',title: 'Exprimer un désaccord',        module: 'lectures', type: 'phrases',    contentId: 'expressing-disagreement', path: '/lectures/phrases/expressing-disagreement', unit: 3 },
            { id: 'a2en-phrases-hotel',   title: "À l'hôtel",                    module: 'lectures', type: 'phrases',    contentId: 'at-the-hotel',            path: '/lectures/phrases/at-the-hotel',       unit: 3 },
            { id: 'a2en-phrases-doctor',  title: 'Chez le médecin',              module: 'lectures', type: 'phrases',    contentId: 'at-the-doctor',           path: '/lectures/phrases/at-the-doctor',      unit: 3 },
            { id: 'a2en-phrases-plans',   title: 'Prendre des rendez-vous',      module: 'lectures', type: 'phrases',    contentId: 'making-plans',            path: '/lectures/phrases/making-plans',       unit: 3 },
            { id: 'a2en-phrases-market',  title: 'Au marché',                    module: 'lectures', type: 'phrases',    contentId: 'at-the-market',           path: '/lectures/phrases/at-the-market',      unit: 3 },
            { id: 'a2en-phrases-postcard',title: 'Écrire une carte postale',     module: 'lectures', type: 'phrases',    contentId: 'writing-a-postcard',      path: '/lectures/phrases/writing-a-postcard', unit: 3 },
            { id: 'a2en-phrases-health',  title: 'Parler de sa santé',           module: 'lectures', type: 'phrases',    contentId: 'talking-about-health',    path: '/lectures/phrases/talking-about-health', unit: 3 },
            { id: 'a2en-reading-job',     title: "Lecture : Sophie's Interview", module: 'lectures', type: 'reading',    contentId: 'a2en-job-interview',      path: '/lectures/reading/a2en-job-interview', unit: 3 },
            { id: 'a2en-reading-shopping', title: 'Lecture : A Shopping Trip',    module: 'lectures', type: 'reading',    contentId: 'a2en-shopping-trip',      path: '/lectures/reading/a2en-shopping-trip', unit: 3 },
            { id: 'a2en-reading-holiday', title: 'Lecture : Planning a Holiday',  module: 'lectures', type: 'reading',    contentId: 'a2en-holiday-plans',      path: '/lectures/reading/a2en-holiday-plans', unit: 3 },
            { id: 'a2en-reading-flatmate',title: 'Lecture : A New Flatmate',      module: 'lectures', type: 'reading',    contentId: 'a2en-new-flatmate',       path: '/lectures/reading/a2en-new-flatmate',  unit: 3 },
            { id: 'a2en-reading-lost',    title: 'Lecture : Lost in a New Town',  module: 'lectures', type: 'reading',    contentId: 'a2en-lost-in-town',       path: '/lectures/reading/a2en-lost-in-town',  unit: 3 },
            { id: 'a2en-reading-cooking', title: 'Lecture : Cooking for Friends', module: 'lectures', type: 'reading',    contentId: 'a2en-cooking-dinner',     path: '/lectures/reading/a2en-cooking-dinner', unit: 3 },
...
export const COURSES: Course[] = [
    {
        ...
        steps: [
            ...
            { id: 'a1-greetings',       title: 'Greetings & Basics',            module: 'vocabulary', type: 'vocabulary', contentId: 'greetings-basics',          path: '/vocabulary/greetings-basics',              unit: 1 },
            { id: 'a1-articles',        title: 'Articles',                       module: 'lectures', type: 'grammar',    contentId: 'articles',                   path: '/lectures/grammar/articles',                 unit: 1 },
            { id: 'a1-noun-gender',     title: 'Noun Gender',                    module: 'lectures', type: 'grammar',    contentId: 'noun-gender',                path: '/lectures/grammar/noun-gender',              unit: 1 },
            { id: 'a1-intro-yourself',  title: 'Introducing Yourself',           module: 'lectures', type: 'phrases',    contentId: 'introducing-yourself',       path: '/lectures/phrases/introducing-yourself',             unit: 1 },
            { id: 'a1-numbers',         title: 'Numbers 1–100',                  module: 'vocabulary', type: 'vocabulary', contentId: 'numbers-time',               path: '/vocabulary/numbers-time',                  unit: 1 },
            { id: 'a1-days-months',     title: 'Days & Months',                  module: 'vocabulary', type: 'vocabulary', contentId: 'days-months',                path: '/vocabulary/days-months',                   unit: 1 },
            { id: 'a1-nationalities',   title: 'Countries & Nationalities',      module: 'vocabulary', type: 'vocabulary', contentId: 'nationalities',              path: '/vocabulary/nationalities',                 unit: 1 },
            { id: 'a1-telling-time',    title: 'Telling the Time',               module: 'lectures', type: 'grammar',    contentId: 'telling-time',               path: '/lectures/grammar/telling-time',             unit: 1 },
            { id: 'a1-classroom',       title: 'Classroom Survival',             module: 'lectures', type: 'phrases',    contentId: 'classroom-survival',         path: '/lectures/phrases/classroom-survival',               unit: 1 },
            // Unit 2 — My World (8 steps)
            { id: 'a1-family',          title: 'Family & Relationships',         module: 'vocabulary', type: 'vocabulary', contentId: 'family-relationships',       path: '/vocabulary/family-relationships',           unit: 2 },
            { id: 'a1-possessives',     title: 'Possessive Adjectives',          module: 'lectures', type: 'grammar',    contentId: 'possessive-adjectives',      path: '/lectures/grammar/possessive-adjectives',    unit: 2 },
            { id: 'a1-stress-pronouns', title: 'Stress Pronouns',                module: 'lectures', type: 'grammar',    contentId: 'stress-pronouns',            path: '/lectures/grammar/stress-pronouns',          unit: 2 },
            { id: 'a1-home',            title: 'Home & Living',                  module: 'vocabulary', type: 'vocabulary', contentId: 'home-living',                path: '/vocabulary/home-living',                   unit: 2 },
            { id: 'a1-prepositions',    title: 'Prepositions of Place',          module: 'lectures', type: 'grammar',    contentId: 'prepositions-place',         path: '/lectures/grammar/prepositions-place',       unit: 2 },
            { id: 'a1-colors',          title: 'Colors & Descriptions',          module: 'vocabulary', type: 'vocabulary', contentId: 'colors-descriptions',        path: '/vocabulary/colors-descriptions',            unit: 2 },
            { id: 'a1-adjectives',      title: 'Adjective Agreement',            module: 'lectures', type: 'grammar',    contentId: 'adjective-basics',           path: '/lectures/grammar/adjective-basics',          unit: 2 },
            { id: 'a1-home-phrases',    title: 'Describing Your Home',           module: 'lectures', type: 'phrases',    contentId: 'describing-your-home',       path: '/lectures/phrases/describing-your-home',             unit: 2 },
            // Unit 3 — Everyday Life (10 steps)
            { id: 'a1-food',            title: 'Food & Drinks',                  module: 'vocabulary', type: 'vocabulary', contentId: 'food-drinks',                path: '/vocabulary/food-drinks',                   unit: 3 },
            { id: 'a1-partitive',       title: 'Partitive Articles',             module: 'lectures', type: 'grammar',    contentId: 'partitive-articles',         path: '/lectures/grammar/partitive-articles',       unit: 3 },
            { id: 'a1-cafe-phrases',    title: 'At the Café',                    module: 'lectures', type: 'phrases',    contentId: 'at-the-cafe',                path: '/lectures/phrases/at-the-cafe',                      unit: 3 },
            { id: 'a1-etre',            title: 'Verb: être',                     module: 'verbs', type: 'verbs',      contentId: 'etre',                       path: '/verbs/etre/table',                        unit: 3 },
            { id: 'a1-avoir',           title: 'Verb: avoir',                    module: 'verbs', type: 'verbs',      contentId: 'avoir',                      path: '/verbs/avoir/table',                       unit: 3 },
            { id: 'a1-aller',           title: 'Verb: aller',                    module: 'verbs', type: 'verbs',      contentId: 'aller',                      path: '/verbs/aller/table',                       unit: 3 },
            { id: 'a1-modals',          title: 'Vouloir, Pouvoir, Devoir',       module: 'lectures', type: 'grammar',    contentId: 'vouloir-pouvoir-devoir',      path: '/lectures/grammar/vouloir-pouvoir-devoir',   unit: 3 },
            { id: 'a1-present-er',      title: 'Present Tense: -ER Verbs',       module: 'lectures', type: 'grammar',    contentId: 'present-tense-er',           path: '/lectures/grammar/present-tense-er',         unit: 3 },
            { id: 'a1-clothing',        title: 'Clothing & Accessories',         module: 'vocabulary', type: 'vocabulary', contentId: 'clothing-accessories',       path: '/vocabulary/clothing-accessories',           unit: 3 },
            { id: 'a1-cafe-reading',    title: 'Reading: Au Café',               module: 'lectures', type: 'reading',    contentId: 'a1-au-cafe',                 path: '/lectures/reading/a1-au-cafe',                       unit: 3 },
            // Unit 4 — Getting Around (8 steps)
            { id: 'a1-transport',       title: 'Transport & Travel',             module: 'vocabulary', type: 'vocabulary', contentId: 'transport-basics',           path: '/vocabulary/transport-basics',              unit: 4 },
            { id: 'a1-directions',      title: 'Asking for Directions',          module: 'lectures', type: 'phrases',    contentId: 'asking-directions',          path: '/lectures/phrases/asking-directions',                unit: 4 },
            { id: 'a1-negation',        title: 'Negation',                       module: 'lectures', type: 'grammar',    contentId: 'negation',                   path: '/lectures/grammar/negation',                 unit: 4 },
            { id: 'a1-questions',       title: 'Asking Questions',               module: 'lectures', type: 'grammar',    contentId: 'questions',                  path: '/lectures/grammar/questions',                unit: 4 },
            { id: 'a1-futur-proche',    title: 'Le Futur Proche',                module: 'lectures', type: 'grammar',    contentId: 'futur-proche',               path: '/lectures/grammar/futur-proche',             unit: 4 },
            ...
            { id: 'a1-faire',           title: 'Verb: faire',                    module: 'verbs', type: 'verbs',      contentId: 'faire',                      path: '/verbs/faire/table',                       unit: 5 },
            { id: 'a1-venir',           title: 'Verb: venir',                    module: 'verbs', type: 'verbs',      contentId: 'venir',                      path: '/verbs/venir/table',                       unit: 5 },
            { id: 'a1-health-phrases',  title: 'Talking About Health',           module: 'lectures', type: 'phrases',    contentId: 'talking-about-health',       path: '/lectures/phrases/talking-about-health',             unit: 5 },
            { id: 'a1-famille-martin',  title: 'Reading: La Famille Martin',     module: 'lectures', type: 'reading',    contentId: 'a1-la-famille-martin',       path: '/lectures/reading/a1-la-famille-martin',             unit: 5 },
            { id: 'a1-journee-typique', title: 'Reading: Une Journée Typique',   module: 'lectures', type: 'reading',    contentId: 'a1-une-journee-typique',     path: '/lectures/reading/a1-une-journee-typique',           unit: 5 },
            { id: 'a1-au-marche',       title: 'Reading: Au Marché',             module: 'lectures', type: 'reading',    contentId: 'a1-au-marche',               path: '/lectures/reading/a1-au-marche',                     unit: 5 },
        ],
    },
    {
        level: 'A2',
        ...
        steps: [
            ...
            { id: 'a2-work',              title: 'Work & Professions',            module: 'vocabulary', type: 'vocabulary', contentId: 'work-professions',          path: '/vocabulary/work-professions',                   unit: 1 },
            { id: 'a2-passe-compose',     title: 'Passé Composé',                 module: 'lectures', type: 'grammar',    contentId: 'passe-compose',             path: '/lectures/grammar/passe-compose',                 unit: 1 },
            { id: 'a2-imparfait',         title: "L'Imparfait",                   module: 'lectures', type: 'grammar',    contentId: 'imparfait-intro',            path: '/lectures/grammar/imparfait-intro',               unit: 1 },
            { id: 'a2-passe-vs-imparfait',title: 'Passé vs Imparfait',            module: 'lectures', type: 'grammar',    contentId: 'passe-compose-vs-imparfait', path: '/lectures/grammar/passe-compose-vs-imparfait',    unit: 1 },
            ...
            { id: 'a2-at-doctor',         title: 'At the Doctor',                 module: 'lectures', type: 'phrases',    contentId: 'at-the-doctor',              path: '/lectures/phrases/at-the-doctor',                         unit: 4 },
            { id: 'a2-depuis-pendant',    title: 'Depuis / Pendant',              module: 'lectures', type: 'grammar',    contentId: 'depuis-pendant',             path: '/lectures/grammar/depuis-pendant',                unit: 4 },
            { id: 'a2-conversation',      title: 'Everyday Conversation',         module: 'lectures', type: 'phrases',    contentId: 'everyday-conversation',      path: '/lectures/phrases/everyday-conversation',                 unit: 4 },
            ...
            { id: 'a2-reflexive',         title: 'Reflexive Verbs: Full',         module: 'lectures', type: 'grammar',    contentId: 'reflexive-verbs',            path: '/lectures/grammar/reflexive-verbs',               unit: 5 },
            { id: 'a2-adverbs',           title: 'Adverbs',                       module: 'lectures', type: 'grammar',    contentId: 'adverbs-ment',               path: '/lectures/grammar/adverbs-ment',                  unit: 5 },
            { id: 'a2-seasons-activities',title: 'Seasons & Activities',          module: 'vocabulary', type: 'vocabulary', contentId: 'seasons-activities',         path: '/vocabulary/seasons-activities',                 unit: 5 },
            { id: 'a2-reading-marche',    title: 'Reading: Le Marché du Dimanche',module: 'lectures', type: 'reading',    contentId: 'a2-le-marche',               path: '/lectures/reading/a2-le-marche',                          unit: 5 },
    ...
    },
    {
        ...
        steps: [
            ...
            { id: 'b2-reading-sh1',           title: 'Reading: Sherlock Holmes Ch.1',  module: 'lectures', type: 'reading',    contentId: 'sherlock-holmes-ch1',           path: '/lectures/reading/sherlock-holmes-ch1',                    unit: 4 },
            { id: 'b2-reading-sh2',           title: 'Reading: Sherlock Holmes Ch.2',  module: 'lectures', type: 'reading',    contentId: 'sherlock-holmes-ch2',           path: '/lectures/reading/sherlock-holmes-ch2',                    unit: 4 },
